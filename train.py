...
def get_ds(config):
    print("-------", config['lang_src'], config['lang_tgt'], "----------")
...
def train_model(config):
    ...
    if config['preload']:
        ...
        optimizer.load_state_dict(state['optimizer_stat`'])
    ...
    for epoch in range(initial_epoch, config['num_epochs']):
        ...
        for batch in batch_iterator:
            ...
            # Run the tensors through encoder
            ...
            # Log the loss
            writer.add_scaler('train loss', loss.item(), global_step=global_step)
            writer.flush()
